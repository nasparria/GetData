...
// 	log.Info("GetOrdersByTicker called with ticker: ", req.GetTicker())

// 	produceKafkaMessage("GetOrdersByTicker invoked for ticker: " + req.GetTicker())

// 	collection := s.db.Collection("orders")
// 	filter := bson.M{"ticker": req.GetTicker()}
// 	cursor, err := collection.Find(ctx, filter)
// 	if err != nil {
// 		log.Error("Error finding orders by ticker: ", err)
// 		return nil, err
// 	}
...
// 			log.Error("Error decoding MongoDB cursor: ", err)
// 			return nil, err
// 		}
...
// 		log.Error("Error with cursor after iteration: ", err)
// 		return nil, err
// 	}

// 	log.Info("GetOrdersByTicker successful. Returning ", len(orders), " orders.")
...
// 	log.Info("GetOrdersbyAccount called with account: ", req.GetAccount())

// 	produceKafkaMessage("GetOrdersByAccount invoked for account: " + req.GetAccount())
// 	collection := s.db.Collection("orders")
// 	filter := bson.M{"account": req.GetAccount()}
// 	cursor, err := collection.Find(ctx, filter)
// 	if err != nil {
// 		log.Error("Error finding orders by account: ", err)
// 		return nil, err
// 	}
// 	defer cursor.Close(ctx)
...
// 	log.Info("GetOrdersbyAccount successful. Returning ", len(orders), " orders.")
// 	return &protogen.OrdersResponse{Orders: orders}, nil
// }
// func produceKafkaMessage(messageContent string) {
...
// 	if err != nil {
// 		log.Error("Error writing Kafka message: ", err)
// 	} else {
// 		log.Info("Successfully sent Kafka message: ", messageContent)
// 	}
// }
